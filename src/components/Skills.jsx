...
function SkillItem({ Icon, label, imgSrc, Custom }) {
  ...
  return (
    <HoverLift
      className="w-44 sm:w-48 text-center flex flex-col items-center gap-2
...
export default function Skills() {
  ...
  return (
    <Reveal className="glass rounded-2xl p-6 lg:p-8">
      ...
      {/* 🐧 Nueva sección: Sistemas / GNU·Linux */}
      <h3 className="text-lg font-semibold mb-3 text-center">Sistemas / GNU·Linux</h3>
      <div className="flex flex-wrap justify-center gap-4 mb-8">
        {sistemas.map((it) => (
          <SkillItem key={it.label} {...it} />
        ))}
