    ...
    return (
        <header className="sticky top-0 z-50 bg-stone-50/95 dark:bg-zinc-950/95 backdrop-blur-sm border-b border-stone-200 dark:border-zinc-800">
            <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
                ...
                >
                    <span className="text-orange-500">&gt;</span> Federico Barrios
                </Link>
                ...
                <button
                    ...
                    className="p-2 rounded-none border-2 border-stone-200 dark:border-zinc-700 hover:bg-stone-100 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-stone-50 transition-colors"
                >
                ...
                <button
                    type="button"
                    className="sm:hidden p-2 rounded-none border-2 border-stone-200 dark:border-zinc-700 hover:bg-stone-100 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 transition-colors"
